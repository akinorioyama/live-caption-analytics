// for inbrowser
// replace chrome.runtime.getURL with chrome_runtime_getURL
  const chrome_runtime_getURL = (pathStr) => {
    const returnPath = '../static/'+ pathStr;
    return returnPath;
  };

  // let i18n_object = null;
  let en_json = "";
  let ja_json = "";
  const getConfig = async() => {
  let request = new Request('static/locales/en.json');
  ...
  let request_ja = new Request('static/locales/ja.json');
  fetch(request_ja).then( function(response){
    return response.text().then( function(text) {
        console.log(text);
        ja_json = text;
    })
...
try {
  ...
  const url_css_file = chrome_runtime_getURL("css/style.css");
  css_file.setAttribute('src', url_css_file);
  node_head.appendChild(css_file);
  // const en_json = fetch('static/locales/en.json');
  // import i18next from "https://cdnjs.cloudflare.com/ajax/libs/i18next/2.0.22/i18next.min.js";
...
;(() => {
  ...
  //
  ////////////////////////////////////////////////////////////////////////////
  let connection_warning_issued = false;
  let i18next_local_object;
  const get_i18n_object = () => {
// function get_i18n_object(){
   const en_json = {
    "text_you": {
        "message": "You"
    },
    "alert_to_change_lanauge": {
        "message": "add ?hl=en at the end of the URL. For example, https://meet.google.com/ccc-cccc-ccc?hl=en"
    },
    "alart_to_notify_no_pending_transcript": {
        "message" : "No text in caption.<br> Press when immediate transcript is available."
    },
    "alart_to_notify_pending_transcript": {
        "message" : "Please choose a word to record for study log, or press Esc to cancel logging.<br><br>"
    },
    "realtime_caption_to_send_to_log": {
        "message" : "Choose a word to record as unrecognized one<br><br>"
    },
    "realtime_no_caption_to_send_to_log": {
        "message" : "No text in caption."
    },
    "realtime_caption_notify_the_option": {
        "message" : "Unrecognized words recording option can be turned on via option settings"
    },
    "show_stats_option": {
        "message" : "Statistics such as turn taking ratio can be turned on via option settings"
    },
    "show_option_feedback": {
        "message" : "Feedback such as applause to use a designated phrase can be turned on Receive feedback via option settings"
    },
    "record_log" :
    {
        "message" : "You have chosen $action$ to record as log",
        "placeholders": {
          "action": { "content": "$1" }
        }
    },
    "record_to_review" :
    {
        "message" : "Text $word$ recorded as a word to review",
        "placeholders": {
          "word": { "content": "$1" }
        }
    },
    "record_unrecognized" :
    {
        "message" : "Text $word$ recorded as unrecognized word",
        "placeholders": {
          "word": { "content": "$1" }
        }
    },
    "alart_to_ask_to_answer_the_prompt":
    {
        "message" : "Select an option to answer the question"
    },
    "prompt_no_answer": {
        "message" : "You didn't select any option."
    },
    "prompt_for_an_option" :
    {
        "message" : "Option $word$ is selected",
        "placeholders": {
          "word": { "content": "$1" }
        }
    },
    "prompt_during_edit": {
        "message" : "Drag areas to move color-filled areas. Click the setting icon again to freeze the adjusted positions. Hold down control key to change the right edge and the bottom edge."
    },
    "oauth_not_authenticated":{
        "message" : "Not authenticated"
    },
    "oauth_valid_thru":{
        "message" : "Authenticated until "
    },
    "oauth_stopped_or_failed": {
        "message" :  "authentication stopped or failed."
    },
    "oauth_clearing_auth_data": {
        "message" :" Clear authenticated data"
    },
    "oauth_request_to_authenticate": {
        "message" : "authenticate yourself"
    },
    "oauth_notify_expiration": {
        "message": "Authenticated data expired."
    },
    "oauth_notify_soon_to_be_expired": {
        "message": "Authenticatation is about to expire. Authenticate yourself"
    },
    "oauth_not_verified_on_server": {
        "message": "Authenticatation is not verified on server. You need to authenticate again. Authenticate yourself?"
    },
    "server_not_reached_with_errors" :
    {
        "message" : "Error issued when the extension is trying to receive response from your analytics server. Access <a href='$server_url$' target='_blank'>your analytics server (click here)</a> to see if the server is up and running.",
        "placeholders": {
          "server_url": { "content": "$1" }
        }
    },
    "google_speech_to_text_prompt": {
        "message": "Browser built-in caption will use Google's speech to text. Please press OK to accept privacy policy of Web Speech API explained at URL:https://www.google.com/chrome/privacy/whitepaper.html#speech under the section named Speech to text."
    },
    "google_speech_to_text_approved": {
        "message": "You have accepted privacy statement of Google speech to text. Live caption has started."
    },
    "google_speech_to_text_rejected": {
        "message": "You have rejected privacy statement of Google speech to text. Live caption is not initiated."
    },
    "confirm_destination_security":{
        "message": "Read the document about security risk in the link marked as ? above the URL input field. Choose OK to accept the choice and to consent to the conditions highlighted in the document."
    },
    "confirm_destination_rejected": {
        "message": "You rejected the new URL value. The option screen will close without saving new values."
    },
    "connection_warning_issued": {
        "message": "Configure receiving server"
    },
    "hello": { "message": "hallow"},
};
   const ja_json = {
    "text_you": { "message": "あなた" },
    "alert_to_change_lanauge": {
        "message": "URL の最後に ?hl=en を加えてください。一例としては、次のようなURL に変更してください。https://meet.google.com/ccc-cccc-ccc?hl=en"
    },
    "alart_to_notify_no_pending_transcript": {
        "message" : "画面に残っている字幕がありません。<br>字幕がある時に再度お試しください。"
    },
    "alart_to_notify_pending_transcript": {
        "message" : "振り返り用に保存するため、単語を選んでクリックしてください。保存しない場合にはEsc を押してキャンセルしてください。<br><br>"
    },
    "realtime_caption_to_send_to_log": {
        "message" : "振り返り用に誤って音声認識された箇所を保存するには単語を選んでクリックしてください。<br><br>"
    },
    "realtime_no_caption_to_send_to_log": {
        "message" : "画面に残っている字幕がありません。"
    },
    "realtime_caption_notify_the_option": {
        "message" : "誤って音声認識された単語を記録するには、拡張機能のオプションで unrecognized word にチェックを入れてください"
    },
    "show_stats_option": {
        "message" : "発話割合などの統計を表示するには、拡張機能のオプションで Receive statistics にチェックを入れてください"
    },
    "show_option_feedback": {
        "message" : "フィードバックを表示するには、拡張機能のオプションで Receive feedback にチェックを入れてください"
    },
    "record_log" :
    {
        "message" : "「$action$」としてを振り返り用に記録しました",
        "placeholders": {
          "action": { "content": "$1" }
        }
    },
    ...
    "record_unrecognized" :
    {
        "message" : "「$word$」を誤認識された単語として記録しました",
        "placeholders": {
          "word": { "content": "$1" }
        }
    },
    "alart_to_ask_to_answer_the_prompt":
    {
        "message" : "選択肢をクリックして選んでください"
    },
    "prompt_no_answer": {
        "message" : "選択肢を選んで回答しませんでした"
    },
    "prompt_for_an_option" :
    {
        "message" : "「$word$」を選んで回答しました",
        "placeholders": {
          "word": { "content": "$1" }
        }
    },
    "prompt_during_edit": {
        "message" : "塗りつぶし領域をドラッグして移動してください。設定アイコンを再度押すと移動箇所で固定されます。コントロールキーを押し続けると、右側(幅)と下側(高さ)を変更できます"
    },
    "oauth_not_authenticated":{
        "message" : "認証されていません"
    },
    ...
    "oauth_notify_soon_to_be_expired": {
        "message": "認証の有効期間が間もなく修了します。認証してください"
    },
    "oauth_not_verified_on_server": {
        "message": "認証がサーバーで確認できませんでした。再度認証が必要です。認証してください"
    },
    "server_not_reached_with_errors" :
    {
        "message" : "拡張機能が交信しようとしたanalytics server から応答がありませんでした。<a href='$server_url$' target='_blank'>analytics server(ここをクリック)</a>を開いて設定しているサーバーが動作しているか確認してください",
        "placeholders": {
          "server_url": { "content": "$1" }
        }
    },
    "google_speech_to_text_prompt": {
        "message": "ブラウザの音声認識はGoogle のspeech to text を利用します。https://www.google.com/chrome/privacy/whitepaper.html#speech のSpeech to text のプライバシーの取り扱いに同意の上、OKを選択してください。"
    },
    "google_speech_to_text_approved": {
        "message": "プライバシーの取り扱いに同意されましたので、ブラウザの音声認識を開始します"
    },
    "google_speech_to_text_rejected": {
        "message": "プライバシーの取り扱いに同意されませんでしたので、ブラウザの音声認識は利用できません"
    },
    "confirm_destination_security":{
        "message": "安全上の危険に関する文書を読んで、ご理解の上、同意される場合のみOKを選択してください。文書は、URL の入力項目の上部にある(?)の印で表示されているリンクを押して表示してください。"
    },
    "confirm_destination_rejected": {
        "message": "新しいURL の値を拒否しました。設定画面を保存せずに閉じます。"
    },
    "connection_warning_issued": {
        "message": "送信先宛先を指定してください"
    },
    "hello": { "message": "hallow"},

} ;
   let ja_json_adjusted = {};
   let en_json_adjusted = {};
   for (let item in en_json){ en_json_adjusted[item] = en_json[item]['message']}
   for (let item in ja_json){ ja_json_adjusted[item] = ja_json[item]['message']}

   i18next.init({
    lng: 'ja', // evtl. use language-detector https://github.com/i18next/i18next-browser-languageDetector
    fallbackLng: ["en"],
    resources: { // evtl. load via xhr https://github.com/i18next/i18next-xhr-backend
        en: { translation: en_json_adjusted },
        es: { translation: {"hello": "hallow" },
        },
        ja: { translation: ja_json_adjusted },
    }
    });
    return i18next;
}
  ...
  const chrome_i18n_getMessage = (message_id) => {
   // i18next.init({
   //  lng: 'ja', // evtl. use language-detector https://github.com/i18next/i18next-browser-languageDetector
   //  fallbackLng: ["en"],
   //  resources: { // evtl. load via xhr https://github.com/i18next/i18next-xhr-backend
   ...
   //
      ...
      const translated_string = i18next_local_object.t(message_id);
  ...
  const get_Localstorate_Item = (item_string) => {
    ...
    if (localstorage_temp!==null){
      ...
      console.log(str_in_lower_case);
      if (str_in_lower_case !== ""){
        try {
  ...
  const getAllStorageSyncDataInbrowser = () => {
    ...
    // }, (items) => {
        ...
        speava_server_url_to_record =         localStorage.getItem('speava_session_record');
        ...
        speava_session_option_string =        get_Localstorate_Item('speava_session_option_string');
        speava_session_window_positions =     get_Localstorate_Item('speava_session_window_positions');
        ...
        speava_oauth_client_id = localStorage.getItem('speava_oauth_client_id');
  ...
  const open_option_dialogInbrowser = () => {
    if (null) {
      ...
      fetch(request).then( function(response){
        return response.text().then( function(text) {
          ...
          const save_options = () => {
            ...
            localStorage.setItem('speava_session_text_color',speava_session_text_color);
          ...
          const updateWarnSecurity = (e) => {
            const grant_text = chrome_i18n_getMessage("confirm_destination_security");
            const rejected_text = chrome_i18n_getMessage("confirm_destination_rejected");
          ...
          const restore_options = () => {
            ...
            //   document.getElementById('speava_oauth_client_id').value = items.speava_oauth_client_id;
              ...
              speava_select_language = localStorage.getItem('speava_select_language');
              const item_number = list_of_codes( speava_select_language);
              document.getElementById('select_language').value = item_number;
              updateCountry();
              // dialect has to be set after script populats country values
              document.getElementById('select_dialect').value = speava_select_language;
            // });
          }
  ...
  const open_auth_dialogInbrowser = (message_type) => {
    window.open("/test");
  }
  ...
  const startTranscribing = () => {
    ...
    if (hostname.match("meet.google") !== null){
      ...
      const grant_text = chrome_i18n_getMessage("google_speech_to_text_prompt");
      const approved_text = chrome_i18n_getMessage("google_speech_to_text_approved");
      const rejected_text = chrome_i18n_getMessage("google_speech_to_text_rejected");
      let result = false;
      result = window.confirm(grant_text);
      if (result !== true){
  ...
  const startDisplayFormat = () => {
    apply_opacity(0.5);
    const msg_string_display_format = chrome_i18n_getMessage("prompt_during_edit");
...
// 20220802
        ...
        if (isTextAreaCreated !== null) {
            ...
            if (json_text.prompt_options !== ""){
              if (document.getElementById('option_prompt_dialog') === null){
                if ('not_authenticated' in json_text[0]){
                  if (json_text[0].not_authenticated === true){
                    open_auth_dialog("clear");
                    isLoggedIn = false;
                    const msg_string_auth = chrome_i18n_getMessage("oauth_not_verified_on_server");
  ...
  const optionPrompt = (json_text) => {
    return new Promise((resolve, reject) => {
      ...
      const msg_text = chrome_i18n_getMessage('alart_to_ask_to_answer_the_prompt');
      ...
      if (prompt_text.length === 0) {
        ...
        setTimeout( function() {
          const message_text = chrome_i18n_getMessage("prompt_no_answer");
      ...
      for (let new_counter = 0; new_counter < counter ;new_counter++) {
        document.getElementById(`prompttext${new_counter}`).addEventListener('click', e => {
          const message_text = chrome_i18n_getMessage("prompt_for_an_option",e.target.innerText);
          toast_to_notify('<div style="font-size:24px;">' +
              message_text +
              '</div>',2000);
    ...
    const processReceivedReplyShow = (response) => {
        response.json().then(function (json_text) {
            if (connection_warning_issued == true)connection_warning_issued = false;
    ...
    const recordingPrompt = () => {
        return new Promise((resolve, reject) => {
            ...
            let inner_text = "";
            if (prompt_text.length === 0){
              const msg_text = chrome_i18n_getMessage('alart_to_notify_no_pending_transcript');
              inner_text = `<form><div style="display:inline; font-size:48px;">${msg_text}</div>`;
            } else {
              const msg_text = chrome_i18n_getMessage('alart_to_notify_pending_transcript');
              inner_text = `<form><div style="display:inline; font-size:48px;">${msg_text}</div>`;
            }
...
//     }
            ...
            for (let new_counter = 0; new_counter < counter ;new_counter++) {
              document.getElementById(`hinttext${new_counter}`).addEventListener('click', e => {
                ...
                const message_text = chrome_i18n_getMessage("record_to_review",e.target.innerText);
                toast_to_notify('<div style="font-size:24px;">' +
                    message_text +
                    '</div>',1500);
        ...
        speava_async_response_notification = fetch(url,
            {
              ...
              console.log(error);
              speava_async_response_notification = null;
// may send at a certain pace to allow configuration
              if (connection_warning_issued == false){
                connection_warning_issued = true;
                // disable access until save is pressed
                speava_session_show = false;
                speava_session_notification = false;
                speava_session_prompt = false;
                const msg_string_auth = chrome_i18n_getMessage("connection_warning_issued");
                const json_options_auth = {
                  heading: msg_string_auth,
                  prompt_options: "",
                  setting: {duration:300}
                }
                PromptGeneric(json_options_auth);
              };
        });
  ...
  const show_unavailable_error = (element_id_of_area) => {
    ...
    const not_available_message = chrome_i18n_getMessage("server_not_reached_with_errors",speava_server_url_to_record);
  ...
  const sendData = () => {
    if (isTextAreaCreated !== null) {
      ...
      if (!speava_session_unrecognized) {
        const msg_text = chrome_i18n_getMessage('realtime_caption_notify_the_option');
      ...
      //   let inner_text = "";
      //   if (prompt_text.length === 0) {
      //     const msg_text = chrome_i18n_getMessage('realtime_no_caption_to_send_to_log')";
      //     inner_text = `<form><div style="display:inline; font-size:48px;">${msg_text}</div>`;
      //   } else {
      //     const msg_text = chrome_i18n_getMessage('realtime_caption_to_send_to_log')";
      //     inner_text = `<form><div style="display:inline; font-size:48px;">${msg_text}</div>`;
      //   }
      //   for (let item of prompt_text) {
      //     item_texts = item[3];
      ...
      //       // TODO: startAt may suit better for the logging purpose as it captures the begining of the caption line
      //       const message_text = chrome_i18n_getMessage("record_unrecognized", e.target.innerText)';
      //       toast_to_notify('<div style="font-size:24px;">' +
      //           message_text +
      //           '</div>', 1500);
      ...
      if (!speava_session_notification) {
        ...
        notification_area.innerHTML = chrome_i18n_getMessage("show_option_feedback");
      }
      if (!speava_session_show){
        const feedback_textarea = document.getElementById("speava_textarea");
        feedback_textarea.innerHTML = chrome_i18n_getMessage("show_stats_option");
      } else {
        if (speava_async_response_show === null || speava_async_response_show === undefined) {
          if (isShowing === true) {
            try {
              ...
              speava_async_response_show = null;
// inbrowser
                // check heartbeat one time.
                //   on once, then off once connection is established
                if (connection_warning_issued == false){
                    connection_warning_issued = true;
                    speava_session_show = false;
                    speava_session_notification = false;
  ...
  // -------------------------------------------------------------------------
  const addButtons = () => {
    i18next_local_object = get_i18n_object();
    if (is_synced === null){
      return;
    }
    if (isTextAreaCreated === null) {
      ...
      if (document.getElementById('session_id').innerHTML !== "" ){
        speava_session_id =              document.getElementById('session_id').innerHTML;
        localStorage.setItem ('speava_session_id',speava_session_id) ;
      }
      ...
      const url_icon_display_fomrat = chrome_runtime_getURL("icons/icon_display.png");

      const reactionFocus_log_action = () => log_action(currentTranscriptId);
      const open_options = () => open_option_dialogInbrowser();
  ...
  const add_option_buttons = (log_record_type_Button) => {
      ...
      for (let item of log_options) {
        ...
        log_record_type_obj.addEventListener('click', e => {
          ...
          const message_text = chrome_i18n_getMessage("record_log",e.target.innerText);
  ...
  const addButtonLoop = () => {
    ...
    if (hostname.match("meet.google") !== null){
      ...
      if ( pathString === null || pathString[2] !== "en") {
        const msg_string = chrome_i18n_getMessage("alert_to_change_lanauge");
...
//       const msg_string_auth = chrome_i18n_getMessage("oauth_not_authenticated")';
...
//       let auth_valid_text ;
//       const msg_string_auth = chrome_i18n_getMessage("oauth_valid_thru")';
...
//     }
    ...
    chrome.runtime.sendMessage({ message: message_to_authentication }, (response) =>  {
        ...
        if (response.message === 'success'){
            ...
            if (speava_access_token_openid!=="") {
              ...
              const msg_string_auth = chrome_i18n_getMessage("oauth_stopped_or_failed");
  ...
  const stopLogin = () => {
    ...
    const msg_string_auth = chrome_i18n_getMessage("oauth_clearing_auth_data");
  ...
  const startLogin = () => {
    ...
    open_auth_dialog("clear");
    const msg_string_auth = chrome_i18n_getMessage("oauth_request_to_authenticate");
  ...
  const login_expiration_loop = () => {
    ...
    if  ( new Date(speava_access_token_validuntil) <= new Date() ) {
      const msg_string_auth = chrome_i18n_getMessage("oauth_notify_expiration");
    ...
    if ( new Date(speava_access_token_validuntil) <= renewal_check_date ) {
      const msg_string_auth = chrome_i18n_getMessage("oauth_notify_soon_to_be_expired");
      const json_options_auth = {
  ...
  getAllStorageSyncDataInbrowser();
